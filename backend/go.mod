module github.com/kaleemubarok/recam/backend
...
require (
	...
	github.com/blaskovicz/go-cryptkeeper v0.0.0-20190930202326-736b85609f91 // indirect
	...
	github.com/tidwall/secret v0.1.0 // indirect
